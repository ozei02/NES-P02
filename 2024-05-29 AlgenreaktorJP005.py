# Gesamtsteuerung Algenreaktor
''' Änderungen für nächste Version: 
- CO2-Begasung
- automatische Dünger-Dosierung
'''
# Version 005: Labor ENNR S2024, Integration Kameramodul
...
sensor = AS7341(i2c)    # Photosensor über I2C

i2c = busio.I2C(board.SCL, board.SDA)
ads = ADS.ADS1115(i2c)  # AD-Wandlermodul über I2C
...
# Globale Variablen
filename1           = "AlgenlaborS24_dark_JP005.csv"
filename2           = "AlgenlaborS24_bright_JP005.csv"
...
lamps_on_time       = 60*60*16      # 16 Stunden
lamps_off_time      = 60*60*8       # 8 Stunden
airpump_on_time     = 60*15         # 15 Minuten
airpump_off_time    = 60*15         # 15 Minuten
abtastzeit_AS7341   = 60*30	        # Abtastrate für Messungen einstellen
messzeit            = 60*60*24*21   # Gesamtmesszeit, bis das Programm automatisch beendet wird
abtastzeit_kamera   = 60*60*1       # 1 Stunde
...
try:
    ...
    while timer-startsec <= messzeit:
        ...
        if timer-lasttime_photosensor >= abtastzeit_AS7341:     
         ...
         # Foto aufnehmen
        if timer-lasttime_foto >= abtastzeit_kamera:
            lasttime_foto = timer
